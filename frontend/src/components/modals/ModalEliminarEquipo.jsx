    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-10">
      <div
        className={`bg-white p-6 rounded-2xl shadow-lg w-full max-w-sm text-center transform transition-all duration-300 ${
          animado ? "scale-100 opacity-100" : "scale-95 opacity-0"
        }`}
      >
        <h2 className="text-xl font-bold text-red-600 mb-4">¿Eliminar equipo?</h2>
        <p className="text-gray-700 mb-6">
          ¿Estás seguro de que deseas eliminar el equipo <strong>{equipo.nombre}</strong>? Esta acción no se puede deshacer.
        </p>
